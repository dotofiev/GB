        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_chef').val(resultat.notification.donnee.chef);
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('directionBudget');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_3" },                            // -- libelle -- //
                    { "data": "col_4" },                            // -- chef -- //
                    { "data": "col_5" },                            // -- telephone -- //
                    { "data": "col_6" },                            // -- remarque -- //
                    { "data": "col_7" },                            // -- exercice_fiscal -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="directionBudget"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('directionBudget=directionBudget_', ''));
                    }
