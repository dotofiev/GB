...
{
    public abstract class BEACNationaliteDAO : GBDAO
    {
        public string form_combo_id { get { return string.Empty; } }

        public string form_combo_libelle { get { return string.Empty; } }

        public static void Ajouter(BEACNationalite obj, long id_utilisateur)
        {
            try
            {
                // -- Unicité du code -- //
        ...
        public static void Modifier(BEACNationalite obj)
        {
            try
            {
                // -- Unicité du code -- //
