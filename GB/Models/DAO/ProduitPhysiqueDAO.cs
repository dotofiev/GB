...
{
    public class ProduitPhysiqueDAO : DAO
    {
        ...
        public string form_name { get { return "produit_physique"; } }
        public string form_combo_libelle { get { return string.Empty; } }


        public ProduitPhysiqueDAO(string context_id, long id_utilisateur)
        {
        ...
        public void Modifier(ProduitPhysique obj)
        {
            try
            {
                // -- Unicité du code -- //
