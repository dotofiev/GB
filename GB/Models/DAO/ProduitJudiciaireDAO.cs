...
{
    public class ProduitJudiciaireDAO : GBDAO
    {
        ...
        public ProduitJudiciaireDAO(string context_id, long id_utilisateur)
        {
            this.context_id = context_id;
            this.id_utilisateur = id_utilisateur;
        }

        public void Ajouter(ProduitJudiciaire obj, long id_utilisateur)
        {
            try
            {
                // -- Unicité du code -- //
                if (Program.db.produits_judiciare.Exists(l => l.code == obj.code))
                {
        ...
        public void Modifier(ProduitJudiciaire obj)
        {
            try
            {
                // -- Unicité du code -- //
                if (Program.db.produits_judiciare.Exists(l => l.id != obj.id && l.code == obj.code))
                {
                    throw new GBException(App_Lang.Lang.Existing_data + " [code]");
                }
        ...
        public void Supprimer(List<long> ids)
        {
            try
            {
                ...
                ids.ForEach(id =>
                {
                    ...
                    Program.db.produits_judiciare.RemoveAll(l => l.id == id);
                });
        ...
        public static ProduitJudiciaire Object(string code)
        {
            try
            {
                // -- Parcours de la liste -- //
