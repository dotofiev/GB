...
{
    public abstract class LocalisationActifDAO : GBDAO
    {
        public static void Ajouter(LocalisationActif obj)
        {
            try
            {
                // -- Unicité du code -- //
        ...
        public static void Modifier(LocalisationActif obj)
        {
            try
            {
                // -- Unicité du code -- //
        ...
        public static LocalisationActif Object(string code)
        {
            try
            {
                // -- Parcours de la liste -- //
        ...
        public static LocalisationActif Object(int id)
        {
            try
            {
                // -- Parcours de la liste -- //
