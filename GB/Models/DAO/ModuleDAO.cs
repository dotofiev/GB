...
namespace GB.Models.DAO
{
    public class ModuleDAO : GBDAO
    {
        ...
        public ModuleDAO(string context_id, long id_utilisateur)
        {
        ...
        public void Ajouter(Module obj)
        {
            ...
            {
                // -- Unicité du code -- //
                if (Program.db.modules.Exists(l => l.code == obj.code))
                {
        ...
        public void Modifier(Module obj)
        {
            try
            {
                // -- Unicité du code -- //
                if (Program.db.modules.Exists(l => l.id != obj.id && l.code == obj.code))
                {
                    throw new GBException(App_Lang.Lang.Existing_data + " [code]");
                }
        ...
        public void Supprimer(List<long> ids)
        {
            try
            {
                ...
                ids.ForEach(id =>
                {
                    ...
                    Program.db.modules.RemoveAll(l => l.id == id);
                });
        ...
        public static Module Object(string code)
        {
            try
            {
                // -- Parcours de la liste -- //
                return
                    Program.db.modules.FirstOrDefault(l => l.code == code);
            }
            #region Catch
            catch (Exception ex)
            {
