...
{
    public class TypeActifDAO : GBDAO
    {
        ...
        public TypeActifDAO(string context_id, long id_utilisateur)
        {
        ...
        public void Ajouter(TypeActif obj)
        {
            ...
            {
                // -- Unicité du code -- //
                if (Program.db.types_actif.Exists(l => l.code == obj.code))
                {
        ...
        public void Modifier(TypeActif obj)
        {
            try
            {
                // -- Unicité du code -- //
                if (Program.db.types_actif.Exists(l => l.id != obj.id && l.code == obj.code))
                {
                    throw new GBException(App_Lang.Lang.Existing_data + " [code]");
                }

                // -- Modification de la valeur -- //
                Program.db.types_actif
        ...
        public void Supprimer(List<long> ids)
        {
            try
            {
                ...
                ids.ForEach(id =>
                {
                    ...
                    Program.db.types_actif.RemoveAll(l => l.id == id);
                });
        ...
        public static TypeActif Object(string code)
        {
            try
            {
                // -- Parcours de la liste -- //
                return
                    Program.db.types_actif.FirstOrDefault(l => l.code == code);
            }
            #region Catch
            catch (Exception ex)
            {
        ...
        public static TypeActif Object(int id)
        {
            try
            {
                // -- Parcours de la liste -- //
                return
                    Program.db.types_actif.FirstOrDefault(l => l.id == id);
            }
            #region Catch
            catch (Exception ex)
            {
