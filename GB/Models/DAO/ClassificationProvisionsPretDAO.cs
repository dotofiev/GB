...
{
    public abstract class ClassificationProvisionsPretDAO : GBDAO
    {
        public string form_combo_id { get { return string.Empty; } }

        public string form_combo_libelle { get { return string.Empty; } }

        public static void Ajouter(ClassificationProvisionsPret obj)
        {
            try
            {
                // -- Unicité du code -- //
        ...
        public static void Modifier(ClassificationProvisionsPret obj)
        {
            try
            {
                // -- Unicité du code -- //
