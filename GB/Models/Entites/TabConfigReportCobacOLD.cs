...
namespace GB.Models.Entites
{
    ...
    public partial class TabConfigReportCobacOLD
    {
        ...
        public string NetEquity { get; set; }
        public Nullable<int> Ponderation { get; set; }
        public decimal serie { get; set; }
        public Nullable<int> ResultAcct { get; set; }
    }
}
