        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    form_id_pays.val(resultat.notification.donnee.id_pays);
                    form_code_pays.val(resultat.notification.donnee.code_pays);
                    form_libelle_pays.val(resultat.notification.donnee.libelle_pays);
                    $('#form_zone').val(resultat.notification.donnee.zone);
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('westernUnionZonePays');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_2" },                            // -- pays -- //
                    { "data": "col_3" },                            // -- zone -- //
                    { "data": "col_4", "class": "text-center" }     // -- Action -- //
                ]
            });
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="westernUnionZonePays"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('westernUnionZonePays=westernUnionZonePays_', ''));
                    }
            ...
            form_code_pays.easyAutocomplete({
                ...
                list: {
                    onSelectItemEvent: function () {
                        ...
                        form_libelle_pays.val(form_code_pays.getSelectedItemData().libelle);
                        // -- Mise à jour de l'id -- //
                        form_id_pays.val(form_code_pays.getSelectedItemData().id);
                    },
                    match: {
                        enabled: true
                    }
            ...
            form_libelle_pays.easyAutocomplete({
                ...
                list: {
                    onSelectItemEvent: function () {
                        ...
                        form_code_pays.val(form_libelle_pays.getSelectedItemData().code);
                        // -- Mise à jour de l'id -- //
                        form_id_pays.val(form_libelle_pays.getSelectedItemData().id);
                    },
                    match: {
                        enabled: true
                    }
