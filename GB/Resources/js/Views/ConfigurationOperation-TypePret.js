        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_periode_debut').val(resultat.notification.donnee.periode_debut);
                    $('#form_periode_fin').val(resultat.notification.donnee.periode_fin);
                    $('#form_periodicite').val(resultat.notification.donnee.periodicite);
        ...
        try {
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_5" },                            // -- periode_debut -- //
                    { "data": "col_6" },                            // -- periode_fin -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="typePret"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('typePret=typePret_', ''));
                    }
