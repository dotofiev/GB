        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_jour').val(resultat.notification.donnee.jour);
                    $('#form_mois').val(resultat.notification.donnee.mois);
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('congeBanque');
                }
            );
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="congeBanque"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('congeBanque=congeBanque_', ''));
                    }
