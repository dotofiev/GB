        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_taux').val(resultat.notification.donnee.taux);
                    $('#form_montant').val(resultat.notification.donnee.montant);
                    $('#form_montant_minimal').val(resultat.notification.donnee.montant_minimal);
                    $('#form_montant_maximal').val(resultat.notification.donnee.montant_maximal);
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('parametreBanque');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_4" },                            // -- taux -- //
                    { "data": "col_5" },                            // -- montant -- //
                    { "data": "col_6" },                            // -- montant_minimal -- //
                    { "data": "col_7" },                            // -- montant_maximal -- //
                    { "data": "col_8" },                            // -- devise -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="parametreBanque"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('parametreBanque=parametreBanque_', ''));
                    }
