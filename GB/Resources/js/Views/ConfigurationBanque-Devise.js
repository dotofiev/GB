        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_signe').val(resultat.notification.donnee.signe);
                    $('#form_devise_actuelle').val(resultat.notification.donnee.devise_actuelle);
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="devise"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('devise=devise_', ''));
                    }
