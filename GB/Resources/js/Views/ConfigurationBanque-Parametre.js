...
$(
    function () {
        ...
        try {
            ...
            $('#form_utilisation_chequier').val($GB_DONNEE.parametre.utilisation_chequier.toString().gbCapitalize());
            ...
            $('#form_utilisation_version_centrale').val($GB_DONNEE.parametre.utilisation_version_centrale.toString().gbCapitalize());
            $('#form_periode_de_non_paiement').val($GB_DONNEE.parametre.periode_de_non_paiement);
            $('#form_controler_le_nombre_de_pret').val($GB_DONNEE.parametre.controler_le_nombre_de_pret.toString().gbCapitalize());
            $('#form_controler_le_nombre_de_comptes').val($GB_DONNEE.parametre.controler_le_nombre_de_comptes.toString().gbCapitalize());
            $('#form_tva').val($GB_DONNEE.parametre.tva.toString().gbCapitalize());
            $('#form_controler_session').val($GB_DONNEE.parametre.controler_session.toString().gbCapitalize());
            $('#form_duree_session').val($GB_DONNEE.parametre.duree_session);
            $('#form_sms_banking').val($GB_DONNEE.parametre.sms_banking.toString().gbCapitalize());
            ...
            $('#form_utilisation_litige_methode_cobac').val($GB_DONNEE.parametre.utilisation_litige_methode_cobac.toString().gbCapitalize());
            $('#form_modifier_les_attributs_client_dans_la_branch').val($GB_DONNEE.parametre.modifier_les_attributs_client_dans_la_branch.toString().gbCapitalize());
            $('#form_conter_le_nombre_de_page_dans_historique').val($GB_DONNEE.parametre.conter_le_nombre_de_page_dans_historique.toString().gbCapitalize());
            $('#form_mise_a_jour_position_client').val($GB_DONNEE.parametre.mise_a_jour_position_client.toString().gbCapitalize());
            $('#form_poster_credit').val($GB_DONNEE.parametre.poster_credit.toString().gbCapitalize());
            $('#form_poster_litige_pret').val($GB_DONNEE.parametre.poster_litige_pret.toString().gbCapitalize());
            $('#form_poster_collection_locale').val($GB_DONNEE.parametre.poster_collection_locale.toString().gbCapitalize());
            $('#form_western_union').val($GB_DONNEE.parametre.western_union.toString().gbCapitalize());
            $('#form_poster_bon_de_caisse_et_depot_a_terme').val($GB_DONNEE.parametre.poster_bon_de_caisse_et_depot_a_terme.toString().gbCapitalize());
