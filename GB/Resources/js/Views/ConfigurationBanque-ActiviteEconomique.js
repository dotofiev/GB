        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('activiteEconomique');
                }
            );
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="activiteEconomique"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('activiteEconomique=activiteEconomique_', ''));
                    }
