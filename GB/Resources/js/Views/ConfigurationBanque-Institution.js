...
var form_image_fichier = $('#form_image_fichier');
var btn_table;
var form = $('#form');
        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_motto').val(resultat.notification.donnee.motto);
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('institution');
                }
            );
            ...
            form.on("submit",
                function (e) {
                    ...
                    if (form.parsley().isValid()) {
                        ...
                        // -- Mise à joru des données à envoyer -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="institution"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('institution=institution_', ''));
                    }
