        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('parametreBudgetFrais');
                }
            );
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="parametreBudgetFrais"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('parametreBudgetFrais=parametreBudgetFrais_', ''));
                    }
