        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $("#form_type_operation_compte_client_et_compte_gl").val(resultat.notification.donnee.type_operation_compte_client_et_compte_gl);
                    $("#form_type_operation_compte_gl_et_compte_gl").val(resultat.notification.donnee.type_operation_compte_gl_et_compte_gl);
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('compteConfiguration');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_3" },                            // -- libelle -- //
                    { "data": "col_4" },                            // -- cle -- //
                    { "data": "col_5" },                            // -- type_operation_compte_client_et_compte_gl -- //
                    { "data": "col_6" },                            // -- type_operation_compte_gl_et_compte_gl -- //
                    { "data": "col_7" },                            // -- nature -- //
                    { "data": "col_8" },                            // -- statut -- //
                    { "data": "col_9" },                            // -- devise -- //
                    { "data": "col_10", "class": "text-center" },   // -- date_creation -- //
                    { "data": "col_11" },                           // -- utilisateur_createur -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="compteConfiguration"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('compteConfiguration=compteConfiguration_', ''));
                    }
