        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('uniteInstitutionnelle');
                }
            );
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="uniteInstitutionnelle"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('uniteInstitutionnelle=uniteInstitutionnelle_', ''));
                    }
