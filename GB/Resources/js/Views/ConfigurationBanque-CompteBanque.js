...
var btn_table;
var form = $('#form');
var form_id_banque = $('#form_id_banque');
var form_code_banque = $('#form_code_banque');
var form_libelle_banque = $('#form_libelle_banque');
        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    form_id_banque.val(resultat.notification.donnee.id_banque);
                    form_code_banque.val(resultat.notification.donnee.code_banque);
                    form_libelle_banque.val(resultat.notification.donnee.libelle_banque);
...
$(
    function () {
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('compteBanque');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_2" },                            // -- code_banque -- //
                    { "data": "col_3" },                            // -- libelle_banque -- //
                    { "data": "col_4" },                            // -- code_compte -- //
                    { "data": "col_5" },                            // -- date_creation -- //
        ...
        try {
            ...
            modal_form.on('hidden.bs.modal',
                function (e) {
                    ...
                    form_id_compte.val(0);
                    form_id_banque.val(0);
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="compteBanque"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('compteBanque=compteBanque_', ''));
                    }
        ...
        try {
            ...
            // -- Recherche par code -- //
            form_code_banque.easyAutocomplete({
                url: $GB_DONNEE.Urls.url_ajax_easyAutocomplete + '&id_vue=banque',
                getValue: function (obj) {
                    return obj.code;
                },
                list: {
                    onSelectItemEvent: function () {
                        // -- Mise à jour du champ nom banque -- //
                        form_libelle_banque.val(form_code_banque.getSelectedItemData().libelle);
                        // -- Mise à jour de l'identifiant de l'banque -- //
                        form_id_banque.val(form_code_banque.getSelectedItemData().id);
                    },
                    match: {
                        enabled: true
                    }
            ...
            form_libelle_banque.easyAutocomplete({
                url: $GB_DONNEE.Urls.url_ajax_easyAutocomplete + '&id_vue=banque',
                getValue: function (obj) {
                    return obj.libelle;
                },
                list: {
                    onSelectItemEvent: function () {
                        // -- Mise à jour du champ nom banque -- //
                        form_code_banque.val(form_libelle_banque.getSelectedItemData().code);
                        // -- Mise à jour de l'identifiant de l'banque -- //
                        form_id_banque.val(form_libelle_banque.getSelectedItemData().id);
                    },
                    match: {
                        enabled: true
                    }
