...
var url_ajax_dataTable = '/ConfigurationOperation/Charger_Table/?id_page=' + $GB_DONNEE.id_page;
var url_ajax_selection_enregistrement = '/ConfigurationOperation/Selection_Enregistrement/';
...
var url_suppression = '/ConfigurationOperation/Supprimer_Enregistrement';
        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_nombre_jour_debut').val(resultat.notification.donnee.nombre_jour_debut);
                    $('#form_nombre_jour_fin').val(resultat.notification.donnee.nombre_jour_fin);
                    $('#form_pourcentage').val(resultat.notification.donnee.pourcentage);
                    $('#form_formule').val(resultat.notification.donnee.formule).change();
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('classificationProvisionsPret');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_2" },                            // -- code -- //
                    { "data": "col_3" },                            // -- libelle -- //
                    { "data": "col_4" },                            // -- nombre_jour_debut -- //
                    { "data": "col_5" },                            // -- nombre_jour_fin -- //
                    { "data": "col_6" },                            // -- pourcentage -- //
                    { "data": "col_7" },                            // -- formule -- //
                    { "data": "col_8" },                            // -- type -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="classificationProvisionsPret"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('classificationProvisionsPret=classificationProvisionsPret_', ''));
                    }
