        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_budget_id').val(resultat.notification.donnee.budget_id);
                    $('#form_date_debut').val(resultat.notification.donnee.date_debut);
                    $('#form_date_fin').val(resultat.notification.donnee.date_fin);
...
$(
    function () {
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('exerciceFiscal');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_2" },                            // -- code -- //
                    { "data": "col_3" },                            // -- libelle -- //
                    { "data": "col_4", "class": "text-center" },    // -- date_debut -- //
                    { "data": "col_5", "class": "text-center" },    // -- date_fin -- //
                    { "data": "col_6" },                            // -- statut -- //
                    { "data": "col_7" },                            // -- budget_id -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="exerciceFiscal"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('exerciceFiscal=exerciceFiscal_', ''));
                    }
        ...
        // -- Affectation du pluging de date picket sur les input -- //
        try {
            ...
            $('[data-picker-single]').daterangepicker({
                ...
                locale: {
                    format: ($GB_DONNEE.format_date).toUpperCase()
                }
            });
