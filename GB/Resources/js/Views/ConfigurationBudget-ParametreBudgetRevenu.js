        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_autoriser_control_budget').val(resultat.notification.donnee.autoriser_control_budget);
        ...
        try {
            ...
            table.on('draw.dt',
                function () {
                    ...
                    gbCharger_Css_Table('parametreBudgetRevenu');
                }
            );
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_3" },                            // -- libelle -- //
                    { "data": "col_4" },                            // -- compte -- //
                    { "data": "col_5" },                            // -- autoriser_control_budget -- //
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="parametreBudgetRevenu"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('parametreBudgetRevenu=parametreBudgetRevenu_', ''));
                    }
