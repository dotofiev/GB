        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_adresse_1').val(resultat.notification.donnee.adresse_1);
                    $('#form_adresse_2').val(resultat.notification.donnee.adresse_2);
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="banque"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('banque=banque_', ''));
                    }
