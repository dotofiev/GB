        ...
        $.ajax({
            ...
            success: function (resultat) {
                ...
                if (!resultat.notification.est_echec) {
                    ...
                    $('#form_fax').val(resultat.notification.donnee.fax);
        ...
        try {
            ...
            table.DataTable({
                ...
                "columns": [
                    ...
                    { "data": "col_5" },                            // -- ville -- //
                    { "data": "col_6" },                            // -- adresse -- //
                    { "data": "col_7" },                            // -- telephone -- //
                    { "data": "col_8" },                            // -- bp -- //
                    { "data": "col_9" },                            // -- fax -- //
                    { "data": "col_10" },                            // -- cobac_id -- //
                    { "data": "col_11" },                            // -- beac_id -- //
                    { "data": "col_12" },                            // -- utilisateur -- //
                    { "data": "col_13" },                            // -- ip -- //
                    { "data": "col_14" },                            // -- mot_de_passe -- //
                    { "data": "col_15", "class": "text-center" }     // -- Action -- //
                ]
            });
        ...
        try {
            ...
            btn_supprimer.on("click",
                function () {
                    ...
                    var selection = $('input[name="agence"]:checked');
                    ...
                    for (var i = 0; i < selection.length; i++) {
                        ids.push(selection[i].replace('agence=agence_', ''));
                    }
